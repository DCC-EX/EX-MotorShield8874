...
<img alt="Bottom_Power_Config_Jumpers" src="./static_images/ex_motorshield_power_config-jumpers_bottom.png"> <img alt="Top_Power_Config_Jumper" src="./static_images/ex_motorshield_power_config_jumper_top.png" height="15%">

| Jumper | Function |
|--------|----------|
| Regulator Enable (Regulator Disable on Rev A boards) | Defaults to *ENABLED*. Rev B boards, *solder* between pads to DISABLE onboard 7.2V regulator. Rev A boards *cut* between pads to DISABLE |
...
| Regulator to VIN (labelled 7V2 on Rev B, unlabelled on Rev A) | Defaults to ON, cut to stop providing regulated 7.2V power to VIN to power the Arduino |
