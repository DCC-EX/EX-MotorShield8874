...
<img alt="Bottom_Power_Config_Jumpers" src="./static_images/ex_motorshield_power_config-jumpers_bottom.png"> <img alt="Top_Power_Config_Jumper" src="./static_images/ex_motorshield_power_config_jumper_top.png" height="12%">
